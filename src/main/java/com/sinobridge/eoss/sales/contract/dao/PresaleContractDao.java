/*
 * FileName: PresaleContractDao.java
 * 北京神州新桥科技有限公司
 ...
 * ---------------------------------------------------------------------------------
 * 2015年11月9日 下午3:59:04          guo_kemeng        1.0         To create
 * </p>
 *
 * @since 
 * @see     
 */
@Repository
public class PresaleContractDao extends DefaultBaseDao<PresaleContractModel, Long>{
