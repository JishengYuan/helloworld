 ...
 * ---------------------------------------------------------------------------------
 * 2014年8月21日 上午10:16:39          guo_kemeng        1.0         To create
 * </p>
 *
 * @since 
 * @see     
...
public class MoneyFormatUtil {
    ...
    public static String getChnmoney(String num) {
        ...
        if (strNum.equals("")) {
            ...
            for (i = 0; i < n; i++) {
                p = 0;
                change = subInput.substring(4 * i, 4 * (i + 1));//截取每一个四位组合数
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getChnmoney(12002.56 + ""));
        //getChnmoney("123.12");
    }
}
