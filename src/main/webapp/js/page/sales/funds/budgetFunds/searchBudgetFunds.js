define(function(require, exports, module) {
	...
	var searchBudgetFunds = {
			config: {
				module: 'searchBudgetFunds'
	        },
	        methods :{
	        	initDocument : function(){
	        		...
	        		//选择客户
	        		 $("#_sino_eoss_sales_customerInfo_select").bind('click').click(function(){
	        			 searchBudgetFunds.doExecute('selectCustomerInfo');
	        		 });
	        		 //加载行业下拉框
	        		 searchBudgetFunds.doExecute('getCustomerInfo',"");
		        },
...
//		    							buffera.append('<a class="_customerIdt_select_a" style="" name="_customerIdt_select" id="'+result[i].id+'" href="#_select_spot">'+result[i].name+'</a>');
		    							 ...
		    							 $.ajax({
		    								 ...
		    								 success : function(result){
		    									 ...
		    									 $("a[name='_customerInfo_select']").unbind('click').click(function(){
		    										 ...
		    										 searchBudgetFunds.doExecute('getCustomerInfo',id);
			...
			doExecute : function(flag, param) {
				var method =searchBudgetFunds.methods[flag];
	...
	exports.init = function() {
		searchBudgetFunds.doExecute('initDocument');
	}
});