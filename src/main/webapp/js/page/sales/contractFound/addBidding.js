	...
	var addOrderContract={
	        ...
	        methods :{
	        	initDocument:function(){
	        		...
	        		addOrderContract.doExecute('customerDropSelect','');
...
//					});
				...
				editgrid2:function(){
					...
					gridUrlStore.put(form_chapter.url,gridUrl)//路径
				 ...
				 editgrid3:function(){
					...
					gridUrlStore.put(form_fication.url,gridUrl)//路径
				 ...
				 editgrid4:function(){
					...
					gridUrlStore.put(form_certificate.url,gridUrl)//路径
