define(function(require, exports, module) {
	...
	var changeSalesContractOther = {
			config: {
				module: 'changeSalesContractOther',
...
//			       					 totalCount+=parseInt($(elem).attr("tdPrice"));
	        		...
	        		changeSalesContractOther.methods.getDataTable();
	        		changeSalesContractOther.methods.getContractType();
	        		changeSalesContractOther.methods.getInvoiceType();
	        		changeSalesContractOther.methods.getAccountCurrency();
	        		changeSalesContractOther.methods.getReceiveWay();
	        		changeSalesContractOther.methods.getIndustryAndCustomerIdt();
	        		 //加载附件组件
	        		changeSalesContractOther.methods.showFileField();
		        	//绑定审核确认提交到流程引擎按钮
		        	$("#_sino_eoss_sales_contract_change_submit").unbind('click').click(function () {
		    			changeSalesContractOther.methods.doContractChange();
		        	});
	        		 $("#_sino_eoss_sales_contract_change_cancel").bind('click',function(){
	        			 changeSalesContractOther.methods._back();
	                 });
...
//	        			 _removeProducts($(this).attr("serial_num"));
	        		 ...
	        		 changeSalesContractOther.methods.typeSelectResult($('#_eoss_sales_contractTypeId').val());
	        		//关联备货合同
...
//		    				changeSalesContractOther.methods.typeSelectResult(type);
//		    		}
//		    		};
...
//	            			$('#selectDate').datetimepicker('hide');
		     ...
		     $('#dialogbody').load(frameSrc,data); 
			     ...
			     $('#dsave').click(function () {
			    	 ...
			    	 var tr=$("<tr style='text-algin:center' id='tr_"+newOptions.serial_num+"'>" +
								...
								"<td><span>￥"+show_totalPrice+"</span><input id='_product_totalPrice_"+newOptions.serial_num+"' name='totalPrices' type='hidden' value='"+newOptions.totalPrice+"'></td>" +
	...
	exports.init = function() {
		changeSalesContractOther.methods.initDocument();
	}
	function fmoney(s, n) { 
		n = n > 0 && n <= 20 ? n : 2; 
