	...
	<div class="salecontent">
		...
		<div class="portlet-body form">
			...
			<form id='_sino_eoss_sales_cachet_addform' class='form-horizontal' >
				...
				<!--  隐藏的蓋章状态-->
				<input type='hidden' name='cachetStatus' id='cachetStatus' value="SH"/>
				<!--进入流程后重新审批的标志位-->
				...
				<!-- 小标题start -->
				<div class=" row-inline" >
					<h4 class="form-section-title">销售合同文档（根据实际情况，可不传）</h4>
				</div>
				<!-- 小标题end -->
				<!-- 4行start -->
				<div class=" row-inline" >
			...
			<div class="form-actions">
				<div style='text-align:center;'>
					<a id='_sino_eoss_sales_cachet_reApply' role="button" class="btn btn-success"><i class="icon-ok"></i>重新提交</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a id='_sino_eoss_sales_contract_cachet_NotReSubmit' role="button" class="btn btn-danger"><i class="icon-remove"></i>废弃该合同盖章申請</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a id='_sino_eoss_sales_cachet_back' role="button" class="btn"><i class="icon-remove"></i>取消</a>
				</div>
			</div>
		</div>
	<script language="javascript">
		seajs.use('js/page/sales/cachet/reApply',function(reApply){
			reApply.init();
		});    
	</script>
</body>
