...
<div class="showbody" style="width: 100%;">
	<div class="advancedSearch" style="">
		<div id="allQuery_search_div">
			<ul class="clearfix">
				<li class="advancedSearch_li" style="height: 30px;width:301px;">
			...
			<ul class="clearfix">
				...
				<li class="advancedSearch_li" >
					...
					<div id="_customerIndustry" style="width: 150px;margin-left: 100px;margin-top: -20px;"  >
...
<script language="javascript">
	seajs.use('js/page/sales/contract/multipleSearch', function(multipleSearch) {
		multipleSearch.init();
	});
</script>