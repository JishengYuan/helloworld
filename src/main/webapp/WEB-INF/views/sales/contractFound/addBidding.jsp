	...
	<br>
		...
		<ul class="clearfix" >
			...
			<li id="field_userName" class="li_form" style="width:400px">
				...
				<input type="text" id="expectProfit" name="expectProfit" class="row-input-oneColumn" pattern="number" value="${model.expectProfit}"  placeholder='请输入数字' data-content="请输入数字"/>
			</li>
		</ul>
		<ul class="clearfix" >
			<li id="field_userName" class="li_form" style="width:800px">
				<label class="editableLabel"><span style="color:red;"></span>说明：</label>
				<input type="text" id="applyDesc" name="applyDesc" class="row-input-towColumn"  value="${model.applyDesc}"  placeholder='请输入说明' data-content="请输入说明"/>
			</li>
		</ul>
...
<div class="handprocess_order" id="SheetDiv">
       ...
       <div id="dailogs1" class="modal hide fade" role="dialog" tabIndex="-1" style="width:1070px;height: 510px;">
		...
		<!--按钮组-->
    		<div id="bottom_button" class="handprocess_btngroup">
        		<input id="ok_Add" type="button" value="下一步"  class="btn btn-success">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    		</div>
 ...
 seajs.use('js/page/sales/contractFound/addBidding',function(addBidding){
	 addBidding.init();
    });
</script>
</body>
