...
<!-- 遮盖层div -->
					...
					<table id="_sino_eoss_sales_contract_maproducts_table" style="" class="table  table-bordered table-striped">
					  ...
					  <c:forEach var="salesContractProductModel" items="${model.salesContractProductModel}" varStatus="status">
							<tr style='text-algin:center' id='tr_${ status.index + 1}'>
								...
								<td><span>${salesContractProductModel.equipmentSplace }</span><input id='_product_equipmentSplace_${ status.index + 1}' name='equipmentSplace' type='hidden' value='${salesContractProductModel.equipmentSplace }'><input type='hidden' name='relateContractProductId' value='${salesContractProductModel.id }'/></td>
							</tr>
						</c:forEach>
					  </tbody>
					</table>
	...
	<script language="javascript">
		...
		seajs.use('js/page/sales/contractchange/changeSalesContractProduct',function(changeSalesContractAmount){
