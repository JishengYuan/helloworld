...
<!-- 遮盖层div -->
						...
						<c:forEach var="salesContractProductModel" items="${model.salesContractProductModel}" varStatus="status">
							<c:if test="${salesContractProductModel.relateDeliveryProductId != null&&salesContractProductModel.relateDeliveryProductId != '' }">
								<tr>
									...
									<td name="relateDeliveryProduct_contract" tid="${salesContractProductModel.relateDeliveryProductId }"><input id='_product_Type_${ status.index + 1}' name='contractProductIds' type='hidden' value='${salesContractProductModel.id }'></td>
									...
									<td >${salesContractProductModel.quantity }<input id='_product_quantity_${ status.index + 1}' name='quantitys' type='hidden' value='${salesContractProductModel.quantity }'></td>
									<td ><input id='_product_unitPrice_${ status.index + 1}' name='unitPrices'  class='unitPrices'  style="width:75px;" type='text' value='${salesContractProductModel.unitPrice }'></td>
									<td tdPrice="${salesContractProductModel.totalPrice }"> <span><fmt:formatNumber value="${salesContractProductModel.totalPrice }" type="currency" currencySymbol="￥"/></span><input id='_product_totalPrice_${ status.index + 1}' name='totalPrices' type='hidden' value='${salesContractProductModel.totalPrice }'> </td>
								</tr>
							</c:if>
							<c:if test="${salesContractProductModel.relateDeliveryProductId == null||salesContractProductModel.relateDeliveryProductId == '' }">
								<tr>
								<td name="relateDeliveryProduct_contract_">${ status.index + 1}<input id='_product_Type_${ status.index + 1}' name='contractProductIds' type='hidden' value='${salesContractProductModel.id }'></td>
								<td><span>${salesContractProductModel.productTypeName }</span><input id='_product_Type_${ status.index + 1}' name='productTypes' type='hidden' value='${salesContractProductModel.productType }'><input id='_product_Type_Name_${ status.index + 1}' name='productTypeNames' type='hidden' value='${salesContractProductModel.productTypeName }'></td>
								<td><span>${salesContractProductModel.productPartnerName }</span><input id='_product_Partner_${ status.index + 1}' name='productPartners' type='hidden' value='${salesContractProductModel.productPartner }'><input id='_product_Partner_Name_${ status.index + 1}' name='productPartnerNames' type='hidden' value='${salesContractProductModel.productPartnerName }'></td>
								<td><span>${salesContractProductModel.productName}</span><input id='_product_No_${ status.index + 1}' name='productNos' type='hidden' value='${salesContractProductModel.productNo }'><input id='_product_Name_${ status.index + 1}' name='productNames' type='hidden' value='${salesContractProductModel.productName }'></td>
								<td><span>${salesContractProductModel.serviceStartDate }</span><input id='_product_startTime_${ status.index + 1}' name='serviceStartDates' type='hidden' value='${salesContractProductModel.serviceStartDate }'></td>
								...
								<td><input id='_product_unitPrice_${ status.index + 1}' name='unitPrices'  class='unitPrices'  style="width:75px;" type='text' value='${salesContractProductModel.unitPrice }'></td>
								<td tdPrice="${salesContractProductModel.totalPrice }"><span><fmt:formatNumber value="${salesContractProductModel.totalPrice }" type="currency" currencySymbol="￥"/></span><input id='_product_totalPrice_${ status.index + 1}' name='totalPrices' type='hidden' value='${salesContractProductModel.totalPrice }'><input id='_product_remark_${ status.index + 1}' type='hidden' value='${salesContractProductModel.remark }'></td>
							</tr>
							</c:if>
						</c:forEach>
					  </tbody>
					...
					<table id="_sino_eoss_sales_contract_maproducts_table" style="" class="table  table-bordered table-striped">
					  ...
					  <c:forEach var="salesContractProductModel" items="${model.salesContractProductModel}" varStatus="status">
							<tr style='text-algin:center' id='tr_${ status.index + 1}'>
								...
								<c:if test="${salesContractProductModel.productNo == '1899'}">
									<td><input id='_product_quantity_${ status.index + 1}' name='quantitys' type='text' value='${salesContractProductModel.quantity }' style="width:15px;"></td>
								</c:if>
								<td><input id='_product_unitPrice_${ status.index + 1}' name='unitPrices'  class='unitPrices'  style="width:75px;" type='text' value='${salesContractProductModel.unitPrice }'></td>
								<td tdPrice="${salesContractProductModel.totalPrice }"><span><fmt:formatNumber value="${salesContractProductModel.totalPrice }" type="currency" currencySymbol="￥"/></span><input id='_product_totalPrice_${ status.index + 1}' name='totalPrices' type='hidden' value='${salesContractProductModel.totalPrice }'></td>
	...
	<script language="javascript">
		...
		seajs.use('js/page/sales/contractchange/changeSalesContractAmount',function(changeSalesContractAmount){
