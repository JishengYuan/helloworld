	...
	<div class="portlet-body form">
		...
		<div style="clear:both;"></div>
			...
			<div id="bottom_button" class="handprocess_btngroup">
				<!-- <input type="button" id="_interPurchas_OK" value="确认" class="btn btn-success" style="height:30px;"> -->
				<a id='_interPurchas_OK' role="button" class="btn btn-success"><i class="icon-ok"></i>确认</a>
...
seajs.use('js/page/business/interPurchas/interPurchasReview/managerApproval', function(managerApproval) {
	managerApproval.init();
}); 
</script>
</body>
</html>