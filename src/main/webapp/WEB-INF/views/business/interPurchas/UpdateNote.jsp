...
<div class="salecontent">
	...
	<input type="hidden" id="purchasCode" name="purchasCode" value="${model.purchasCode }" />
	<!--  保存为草稿还是提交的标志位-->
...
<!--设备添加弹出对话框 -------start-->
			 <div id="dailogs1" class="modal hide fade" role="dialog" tabIndex="-1" style="width:800px;height:460px">
				...
				<div class="modal-footer">
					...
					<a id="dsave"  class="btn btn btn-success" >保存</a>
				</div>
			</div>
			<!--设备添加弹出对话框 -------end-->  		
	<!--按钮组-->
 ...
 seajs.use('js/page/business/interPurchas/UpdateNote',function(UpdateNote){
	 UpdateNote.init();
    });
</script>
</body>
