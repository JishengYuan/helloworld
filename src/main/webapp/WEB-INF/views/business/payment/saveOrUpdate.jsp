...
<div class="salecontent">
		<div class="top">
			<div class="caption">
				<i class="icon-reorder"></i>&nbsp;&nbsp;&nbsp;修改付款计划
			    <span class="tright" style="color:#f4606c">该订单可申请的付款计划金额：${orderDueAmnount}元</span>
			</div>
			<div class="tools">
	...
	<h3>订单信息</h3>
		...
		<ul class="clearfix" >
				...
				<%-- <li id="field_userName" class="li_form" style="width: 350px;">
					<label class="editableLabel"> 已付款金额：</label>
	...
	<!--按钮组-->
    		<div id="bottom_button" class="handprocess_btngroup">
        		...
        		<input id="_sino_eoss_payment_reSubmit" type="button" value="重新提交"   class="btn btn-success">
        		<input id="_sino_eoss_payment_end" type="button" value="删除付款计划"   class="btn">
        		<input id="no_back" type="button" value="取消" class="btn">
    		</div>
...
seajs.use('js/page/business/payment/saveOrUpdate', function(saveOrUpdate){
	saveOrUpdate.init();
});    
</script>
