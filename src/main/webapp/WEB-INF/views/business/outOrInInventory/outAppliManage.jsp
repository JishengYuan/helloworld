...
<body>
	<!-- <a class="btn btn-success" data-toggle="modal" target="_self" href="#_sino_eoss_inventory_import_page" role="button" id="_sino_eoss_inventory_import" style="display:none;"><i class="icon-table"></i>导入</a> -->
	<div id="uicTable"></div>
	<script language="javascript">
		seajs.use('js/page/business/outOrInInventory/outAppliManage', function(outAppliManage) {
			outAppliManage.init();
		});
	</script>
</body>
