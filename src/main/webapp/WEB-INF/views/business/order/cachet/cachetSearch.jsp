			...
			<ul class="clearfix">
			    <li class="advancedSearch_li"  style="height: 30px;margin-top: -30px;margin-left:6px;">
					...
					<div id="dateTimeStopDate" class="input-append date">
			  		    <input data-format="yyyy-MM-dd" style="width:144px;margin-left: -6px;" type="text" id="startTime" value="2015-01-01"></input>
					    <span class="add-on">
...
<script language="javascript">
	seajs.use('js/page/business/order/cachet/cachetSearch', function(cachetSearch) {
		cachetSearch.init();
	});
</script>