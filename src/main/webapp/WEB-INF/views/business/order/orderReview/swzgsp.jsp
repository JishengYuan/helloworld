...
<div class="salecontent">
	...
	<div class="portlet-body form">
			...
			<form id="_eoss_business_order" novalidate="novalidate" style="" method="post">
				...
				<input type="hidden" name="local" id="local" value="商务主管审批"/>
...
<br>
				...
				<thead>
						...
						<td class="sino_table_label" style="background:none repeat scroll 0 0 #F3F3F3;" >客户经理</td>
						</c:if>
						<c:if test="${mark=='NC'}">
				 ...
				 <c:forEach var="product" items="${model.businessOrderProductModel}" varStatus="status">
				  <c:if test="${product.salesContractModel.id!=null}">
					<tr>
						...
						<td class="sino_table_label">${product.salesContractModel.creatorName }</td>
     ...
     <script language="javascript">
		seajs.use('js/page/business/order/orderReview/swzgsp', function(swzgsp) {
			swzgsp.init();
		}); 
     </script>
</body>
